...
public class GroupePersonnelDAOJDBC extends DAOJDBC<GroupePersonnel> {
    
    private DAOJDBC<Personnel> persoJDBC;
   
    public GroupePersonnelDAOJDBC() throws SQLException, IOException {
        super();
        persoJDBC = new DAOFactoryJDBC().getPersonnelDAO();
    }
    
    public GroupePersonnel create(final GroupePersonnel obj)
    ...
    public GroupePersonnel update(final GroupePersonnel obj)
            throws SQLException,
            IOException {
        try (Statement stmt = getConnect().createStatement()) {
    ...
    public GroupePersonnel find(final int id) throws SQLException,
    FileNotFoundException, ClassNotFoundException, IOException {
        DatabaseMetaData dbmd = getConnect().getMetaData();
        GroupePersonnel search = null;
        try (Statement stmt = getConnect().createStatement()) {
            try (ResultSet rs = stmt.executeQuery("select *"
                ...
                search = new GroupePersonnel(nomGroupe, id);
                Personnel p;
                GroupePersonnel gp;
                int idComp;
